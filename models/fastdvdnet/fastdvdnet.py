...
class FastDVDnet(nn.Module):
	"""Simple CNN network for FastDVDnet."""
	def __init__(self):
		super(FastDVDnet, self).__init__()
	...
	def forward(self, x, noise_map):
		# Reshape noise_map to match input dimensions
		noise_map = noise_map.expand(-1, -1, x.size(2), x.size(3))
		x = x + noise_map  # Add noise map to input
